...
> Senior engineering as a service. An Atlanta-based software practice shipping consumer products and the B2B APIs behind them.
...
Public repositories in this organization:
...
**Shipped, not staged.** We measure ourselves on what's in production, on a real store, in front of real users. We don't bill for demos. Our public portfolio is the demo.

**AI-native, calibrated.** Claude is in our workflow every day. So are tests, architectural decision documents, and follow-up issues for the cases where the LLM produced something we'd want a human reviewer on. The difference between *"ships fast with AI"* and *"ships junk with AI"* is the calibration. We've built ours.

**Two-sided product thinking.** Consumer apps and the B2B APIs behind them are designed together, with both economies in mind. Where it makes sense, we build them both.

## Contact

- Website — **[xaymaca.io](https://xaymaca.io)**
- Email — **xaymaca@gmail.com**
- Founder — [Vincent Stoessel](https://xaymaca.com)

---

<sub>© 2026 Xaymaca LLC · Atlanta, GA</sub>
